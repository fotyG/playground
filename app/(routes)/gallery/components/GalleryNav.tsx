...
const GalleryNav: React.FC<GalleryNavProps> = ({ projectCount }) => {
  ...
  return (
    <motion.div
      ...
      className="scroll-smooth sticky top-16 lg:top-0 z-30 bg-base-100 bg-opacity-60 backdrop-blur-[0.2rem] py-3 flex items-center gap-x-2 shadow-sm shadow-secondary transition-colors duration-500"
    >
